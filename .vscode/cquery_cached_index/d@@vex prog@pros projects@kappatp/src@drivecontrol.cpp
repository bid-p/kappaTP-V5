...
void checkDriveState() {
  if ((currJoyRT[E_CONTROLLER_ANALOG_LEFT_Y] < driveDeadThresh &&
       joystickFalling(E_CONTROLLER_ANALOG_RIGHT_Y)) ||
      (currJoyRT[E_CONTROLLER_ANALOG_RIGHT_Y] < driveDeadThresh &&
       joystickFalling(E_CONTROLLER_ANALOG_LEFT_Y))) {
...
void driveTank() {
  ...
  */
  powerDrive(currJoyRT[E_CONTROLLER_ANALOG_LEFT_Y],
